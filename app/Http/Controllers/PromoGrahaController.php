...
class PromoGrahaController extends Controller
{
    //
    public function index()
    {
        ...
        return view('graha.index', compact('club', 'withClub'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if (!isset($foundMember)) {
            ...
            if (isset($foundMemberPackage)) {
                return back()->with('error', 'Maaf anda tidak memenuhi syarat & ketentuan untuk membeli promo graha.');
            }
            ...
            if (isset($foundTransaction)) {
                return back()->with('error', 'Maaf anda sudah pernah membeli promo graha.');
            }
        }
        ...
        return view('graha.checkout', compact('packageMembership', 'leadsId', 'data', 'salesList'));
    }
    ...
    public function order(Request $request)
    {
        if (isset($_POST['lead_id']) && isset($_POST['package_membership_id']) && isset($_POST['checkout_id'])) {
            ...
            if ($response->successful()) {
                ...
                return view('graha.order', compact('url'));
