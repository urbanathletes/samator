...
<div class="main">
    ...
    <section class="signup">
        <div class="container-sm">
            <div class="row">
                <div class="col-sm-7">
                    <img src="assets/img/tarakan.png" alt="" class="img-logo" style="margin-bottom: 20px; width: 653px; height: 69px; object-fit: contain; filter: drop-shadow(2px 2px 4px rgba(0,0,0,0.5));">
                    <br>
