        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-7">
                    ...
                    <p class="detail-1">
                        Mulailah fitness journey Anda dengan cara klaim
                        voucher Free Trial di Fitnessworks! <br>
                        Nikmati puluhan jenis kelas setiap minggunya dan rasakan
                        pengalaman fitness dengan fasilitas premium.<br>
                    ...
                    <div class="signup-content">
                        ...
                        <form method="POST" id="signup-form" class="signup-form">
                            ...
                            <div class="form-group">
                                ...
                                <label for="agree-term" class="label-agree-term"><span><span></span></span>Dengan mencentang kotak di sebelah kiri saya menyetujui menerima dan mengikuti semua update, promo, dan informasi Fitnessworks<a href="#" class="term-service">Syarat Ketentuan</a> Berlaku</label>
                                <br>
    ...
    $(".term-service").click(function() {
        Swal.fire({
            html: '<p class="header-rule-1">Syarat dan ketentuan Free Trial :</p>' +
                ...
                '<tr><td style="vertical-align: top;">7</td><td>Wajib membawa kunci handuk sendiri serta mengenakan pakaian olahraga lengkap.</td></tr>' +
                '</tbody></table>',
            showCloseButton: true,
            showConfirmButton: false,
        })
